          ...
          <motion.div style={{ scale }}>
            <ContactSectionText>
              <Text type="heading2" color="grey4">
                Vamos bater um papo e discutir{" "}
                <Text as="span" type="heading2" color="brand1">
                  soluções de futuro para sua empresa
                </Text>
                , juntos!
              </Text>
            </ContactSectionText>
          ...
          <ContactsCards>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Envie-me um e-mail, para enviar feedbacks, sugestões e ideias.
                </Text>
            ...
            <ContactCard>
              ...
              <ContactCardContent>
                ...
                <Text color="grey2" type="body2">
                  Vamos nos contectar e interagirmos, afinal, network nunca é
                  demais.
                </Text>
                <Text
                  as="a"
